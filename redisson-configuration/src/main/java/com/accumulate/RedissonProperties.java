...
import com.accumulate.enums.AddressResolverGroupFactoryType;
import com.accumulate.enums.CodecType;
import com.accumulate.enums.LoadBalancerType;
 ...
 */
@Data
@ConfigurationProperties(prefix = "accumulate.redisson")
